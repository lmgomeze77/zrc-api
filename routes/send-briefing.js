...
async function generateBriefing(){
  ...
  const response=await fetch("https://api.anthropic.com/v1/messages",{
    ...
    body:JSON.stringify({model:"claude-opus-4-20250514",max_tokens:1500,messages:[{role:"user",content:`You are the ZRC Morning Intelligence editor at Zenith Rise Capital. Generate today briefing for ${today}. Structure as clean HTML (no html/body tags). 1. MACRO SNAPSHOT 2. GEOPOLITICAL RISK RADAR 3. COMMODITY & ENERGY SIGNALS 4. ZRC INSIGHT OF THE DAY. Dark navy headers #0a1628, institutional tone.`}]})
  });
